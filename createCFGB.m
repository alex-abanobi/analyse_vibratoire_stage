...
for oi = 3:3:size(measurement_matrix,1)
    measurement_matrix(oi,2) = 0;
end


for oi = 3:3:size(measurement_matrix2,1)
    measurement_matrix2(oi,2) = 0;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for imes = ijb:ijc
   measurement_matrix(ijb:ijb+2,1) =  93;
...
for imes = kjb:kjc
    measurement_matrix2(kjb:kjb+2,1) =  93;
...
% 
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  93;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
% 
% 
