...
dd=1;
for jjc = 1:3:size(Z,2) 
c = 1;
cc = 12000;
for i=1:29
    Z_fen(:,i) = abs(fft(ZR(c:cc,jjc))); % take the fourier transform of 
    F_fen(:,i) = abs(fft(ZR(c:cc,jjc))); % take the fourier transform of 
...
save('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\Z_fen_group_CS1_X_saved.mat','Z_fen_group');
save('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\ZR_CS1_X.mat','ZR');
