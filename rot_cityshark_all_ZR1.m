...
nfZR_CS1_X = nfZR_CS1_X.*(1e8);


nfZR_CS2_X = load('nfZR_CS2_X.mat');
nfZR_CS2_X = nfZR_CS2_X.ZR;
nfZR_CS2_X = nfZR_CS2_X.*(1e8);
...
mkdir('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\MAC_CITY\Citishark_Rotation888');
ccn = 1;
for oj = 1:19
fileID = fopen(strcat('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\MAC_CITY\Citishark_Rotation888\trancon',num2str(oj),'.',ends(oj,:)),'w+');
disp(fileID);
...
ccn = 1;
for oj = 20:38
fileID = fopen(strcat('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\MAC_CITY\Citishark_Rotation888\trancon',num2str(oj),'.',ends2((oj-19),:)),'w+');
disp(fileID);
