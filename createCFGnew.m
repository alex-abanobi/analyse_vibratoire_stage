...
fileID = fopen('.\MAC_CITY\cfg_alex_new.cfg','w+');
...
%inserting stuff
for uiu = 1:19
    measurement_matrix(cb+3:cb2+3,:) = measurement_matrix(cb:cb2,:);
    measurement_matrix(cb:cb+2,:) = add; 
...
fprintf(fileID, './Citishark_Rotation10/trancon1.002\n');
ijb = 1;
ijc = 18;
...
fprintf(fileID, './Citishark_Rotation10/trancon2.003\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
    fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon3.004\n');
for imes = ijb:ijc
   %measurement_matrix(ijb:ijb+2,1) =  1; 
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon4.005\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon5.006\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon6.007\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon7.008\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon8.009\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon9.010\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon10.011\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon11.012\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon12.013\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon13.014\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon14.015\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon15.016\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon16.017\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon17.018\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon18.019\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
fprintf(fileID, './Citishark_Rotation10/trancon19.020\n');
for imes = ijb:ijc
    %measurement_matrix(ijb:ijb+2,1) =  1;
   fprintf(fileID, '%-2d %-2d \n', measurement_matrix(imes,:)); 
end
...
% fprintf(fileID, 'Measurement 1\n');
% fprintf(fileID, './Citishark_Rotation10/trancon20.021\n');
% ijb = 1;
% ijc = 18;
% 
% for imes = ijb:ijc
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 2\n');
% fprintf(fileID, './Citishark_Rotation10/trancon21.022\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 3\n');
% fprintf(fileID, './Citishark_Rotation10/trancon22.023\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 4\n');
% fprintf(fileID, './Citishark_Rotation10/trancon23.024\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 5\n');
% fprintf(fileID, './Citishark_Rotation10/trancon24.025\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 6\n');
% fprintf(fileID, './Citishark_Rotation10/trancon25.026\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 7\n');
% fprintf(fileID, './Citishark_Rotation10/trancon26.027\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 8\n');
% fprintf(fileID, './Citishark_Rotation10/trancon27.028\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 9\n');
% fprintf(fileID, './Citishark_Rotation10/trancon28.029\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 10\n');
% fprintf(fileID, './Citishark_Rotation10/trancon29.030\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 11\n');
% fprintf(fileID, './Citishark_Rotation10/trancon30.031\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 12\n');
% fprintf(fileID, './Citishark_Rotation10/trancon31.032\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 13\n');
% fprintf(fileID, './Citishark_Rotation10/trancon32.033\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 14\n');
% fprintf(fileID, './Citishark_Rotation10/trancon33.034\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 15\n');
% fprintf(fileID, './Citishark_Rotation10/trancon34.035\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 16\n');
% fprintf(fileID, './Citishark_Rotation10/trancon35.036\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 17\n');
% fprintf(fileID, './Citishark_Rotation10/trancon36.037\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 18;
% fprintf(fileID, 'Measurement 18\n');
% fprintf(fileID, './Citishark_Rotation10/trancon37.038\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
...
% ijc = ijc + 6;
% fprintf(fileID, 'Measurement 19\n');
% fprintf(fileID, './Citishark_Rotation10/trancon38.039\n');
% for imes = ijb:ijc
%     measurement_matrix2(ijb:ijb+2,1) =  1;
%    fprintf(fileID, '%-2d %-2d \n', measurement_matrix2(imes,:)); 
% end
