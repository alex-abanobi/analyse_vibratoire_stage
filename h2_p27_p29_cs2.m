...
dd=1;
for jjc = 3:3:size(Z,2) % 1 for Z, 2 for H1, 3 for H2... this is done per column..
c = 1;
cc = 12000;
for i=1:29
...
xlabel('Capteurs (1-6) de la travée (P27-P29) suivant l''axe H2')
ylabel('Frequences modales (Hz)')
title({'Evolution des fréquences modales en fonction de la position des capteurs', 'suivant l''axe H2'});
% height = 700;
% width = 900;
...
ylabel('Amplitude')
title('Spectre de la capteur 6 de la travée (P27-P29) suivant l''axe H2')
set(gca,'fontname','adobe caslon pro bold')
