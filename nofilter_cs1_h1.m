...
title({'Evolution of modal frequencies as a function of the position of the', 'sensors (1-93) along the bride deck, X direction, Line CS1 (no filtering and no averaging)'});
height = 500;
width = 700;
set(gcf,'position',[100,0,width,height])


save('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\nfZ_fen_group_CS1_X_saved.mat','Z_fen_group');
save('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\nfZR_CS1_X.mat','ZR');
