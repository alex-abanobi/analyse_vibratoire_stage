...
Z_fen_group2 = fonc_norm_alreadyfished_all2(Z_fen_group22);
...
save('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\Z_fen_group_CS1_Z_saved.mat','Z_fen_group');
save('D:\abanobi\Documents\STAGEISTERRE\gueguen\Archive\ZR_CS1_Z.mat','ZR');
...
xlabel('Sensors (1-93) along the bridge deck : Z-axis')
ylabel('Modal Frequencies (Hz)')
title({'Evolution of modal frequencies as a function of the position of the', 'sensors (1-93) along the bride deck, Z direction, Line CS1 (windowed and averaged)'});
height = 500;
width = 700;
...
set(gca,'fontname','adobe caslon pro bold')
xlabel('Spatial distance along Z-axis (m)')
ylabel('Amplitude of the mode shape')
title({'Mode Shape 1 : Z-axis - Line CS1','Normalisation with averaging of 2 points around normalized frequency'});
height = 500;
width = 700;
set(gcf,'position',[100,0,width,height])
...
xlabel('Spatial distance along Z-axis (m)')
ylabel('Amplitude of the mode shape')
title({'Mode Shape 1 : Z-axis - Line CS1','Normalisation without averaging around normalized frequency'});
height = 500;
width = 700;
set(gcf,'position',[100,0,width,height])
